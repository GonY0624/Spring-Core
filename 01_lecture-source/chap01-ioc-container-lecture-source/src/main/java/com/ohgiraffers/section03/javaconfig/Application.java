...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   ComponentScan 이란?
        *   base package 로 설정 된 하위 경로에 특정 어노테아션을 가지고 있는
        *   클래스 bean 으로 등록해주는 기능이다.
        *   @Component 어노테이션이 작선 된 클래스를 인식하여 bean 으로 등록해준다.
        *   목적에 따라서 세부 기능을 제공하는
        ...
        *  */
        ...
        System.out.println(memberDAO.save(new MemberDTO(3, "user03", "pass03", "정고은")));
